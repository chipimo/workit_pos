    ...
    knex.schema.hasTable("products").then(function (exists) {
        if (!exists) {
            return (knex.schema
                ...
                table.decimal("buyingPrice").notNullable();
                ...
                table.decimal("sallingprice").notNullable();
                table.decimal("buyingPrice").notNullable();
                table.decimal("initalPrice").notNullable();
                ...
                .createTable("credit_sales", function (table) {
                table.increments("key");
                ...
                table.decimal("GrandTotal").notNullable();
                table.decimal("AmountPaid").notNullable();
                table.decimal("ChangeDue").notNullable();
                table.decimal("Balance").notNullable();
                table.decimal("RtxGrandTotal").notNullable();
                table.decimal("RtxAmountPaid").notNullable();
                table.decimal("RtxChangeDue").notNullable();
                table.decimal("RtxBalance").notNullable();
                table.decimal("Discount").notNullable();
                table.decimal("Card_slipt").notNullable();
                table.decimal("Cash_slipt").notNullable();
                table.string("Date").notNullable();
                ...
                table.string("timeRange").notNullable();
                table.boolean("isBackedUp").notNullable();
                table.timestamp("timestamp").defaultTo(knex.fn.now());
                table.timestamp("modified").defaultTo(knex.fn.now());
                table.decimal("amoun_owing").notNullable();
                table.string("date_to_pay").notNullable();
                ...
                table.string("group").notNullable();
                table.decimal("sellingPrice").notNullable();
                table.decimal("sellingPriceOld").notNullable();
                table.decimal("buyingPrice").notNullable();
                table.decimal("buyingPriceOld").notNullable();
                table.string("supplier").notNullable();
...
var AppDb = /** @class */ (function () {
            ...
            knex.schema.hasTable("products").then(function (exists) {
                if (!exists) {
                    return (knex.schema
                        ...
                        table.string("materialName").notNullable();
                        table.string("measuredBy").notNullable();
                        table.string("quantityStarted").notNullable();
                        table.string("quantityOpening").notNullable();
                        table.string("quantityClosing").notNullable();
                        table.string("DateEntered").notNullable();
                        table.string("DateEnded").notNullable();
                        table.string("DateUpdated").notNullable();
                        table.integer("DateRange").notNullable();
                        ...
                        .createTable("printOuts", function (table) {
    ...
    AppDb.prototype.getPrintOuts = function (sendCallback) {
        knex
            .select()
            .from("printOuts")
            .then(function (config) {
            if (config.length === 0) {
                ...
                sendCallback(config[0].receipts);
            }
        });
    };
    AppDb.prototype.setPrintOuts = function (receipts, sendCallback) {
        knex
            .select()
            .from("printOuts")
            .then(function (config) {
    ...
    AppDb.prototype.HandleTables = function (props, sendCallback) {
        switch (props._type) {
            ...
            case "KitchenTable":
                ...
                break;
            case "print_bill":
                Tables_1.HandleBillPrintOut(props, knex, function (reciveCallback) {
                    sendCallback(reciveCallback);
                });
                break;
    ...
    AppDb.prototype.HandlePrinterGroups = function (props, sendCallback) {
        ...
        switch (props._type) {
            ...
            case "delete":
                knex("printGroups")
                    .where("idKey", props.printer.idKey)
                    .del()
                    .then(function () {
                    sendCallback(true);
                });
            ...
            case "removeFromGroup":
                props.rightChecked.map(function (list) {
                    knex("group")
                        .where("id", list.id)
                        .update({
                        typeId: "not_set",
