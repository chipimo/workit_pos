                  ...
                  Data[0].ingredients.data.map((list) => {
                    ...
                    .select()
                      ...
                      .then(function (DataResult) {
                        const ingrInt =
                        parseInt(listIngr.qnt) * parseFloat(list.Qty);
                            ...
                            .then(() => {
                              dbhook("materialsReport")
                                .insert({
                                  ...
                                  quantityClosing:
                                    parseFloat(DataResult[0].quantity) - ingrInt,
                    ...
                    if (data.length !== 0) {
                      ...
                      dbhook("sales_reports_totals")
                        ...
                        .update({
                          ...
                          Balance:
                            props.data.Balance + parseFloat(data[0].Balance),
                          RtxGrandTotal: props.isTaxInvoice
                            ? parseFloat(props.data.GrandTotal) +
                              parseFloat(data[0].GrandTotal)
                            : props.paymentType === "Credit Card"
                          ...
                          Discount: props.data.Discount
                            ...
                            : 0,
                          totalTaxFinal:
                            Number(props.data.totalTaxFinal) +
                            Number(data[0].totalTaxFinal),
                          totalTax:
                            Number(props.data.totalTax) +
      ...
      dbhook("credit_sales")
        .insert({
          ...
          isBackedUp: configureStore.getState().SocketConn.isConn
            ...
            : false,
          amoun_owing:
            parseFloat(props.data.amounOwing) === 0
              ? parseFloat(props.data.GrandTotal)
