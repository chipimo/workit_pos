...
var CreditSales_1 = require("../../Reports/CreditSales");
...
var index = function (props) {
    ...
    var _c = React.useState(false), openCreditSales = _c[0], setOpenCreditSales = _c[1];
    var _d = React.useState(false), openRepair = _d[0], setOpenRepair = _d[1];
    var _e = React.useState(0), creditReportsRows = _e[0], setCreditReportsRows = _e[1];
    ...
    var handleGetSaleData = function (prop) {
        dataBase_1.default.HandelReports({
            ...
            setCreditReportsRows(callback.data.length);
        });
    };
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", { style: { marginTop: 20 } }),
        React.createElement(core_1.Badge, { badgeContent: creditReportsRows, color: "secondary" },
            React.createElement(core_1.Button, { onClick: function () { return setOpenCreditSales(true); }, style: {
                    width: "100%",
                    marginTop: 10,
                }, variant: "contained", color: "secondary" },
                React.createElement(core_1.Typography, null, "Credit Sales"))),
        ...
        React.createElement("div", null,
            React.createElement(Modal_1.default, { "aria-labelledby": "simple-modal-title", "aria-describedby": "simple-modal-description", open: openCreditSales, className: classes.modal },
                React.createElement("div", null,
                    React.createElement(CreditSales_1.default, null),
                    React.createElement(core_1.Button, { onClick: function () { return setOpenCreditSales(false); }, style: {
                            marginTop: 10,
                        }, variant: "contained", color: "secondary" },
