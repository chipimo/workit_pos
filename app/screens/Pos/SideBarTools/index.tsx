...
import CreditSales from "../../Reports/CreditSales";
...
const index = (props) => {
  ...
  const [openCreditSales, setOpenCreditSales] = React.useState(false);
  const [openRepair, setOpenRepair] = React.useState(false);
  const [creditReportsRows, setCreditReportsRows] = React.useState(0);
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 20 }} />
      <Badge badgeContent={creditReportsRows} color="secondary">
        <Button
          onClick={() => setOpenCreditSales(true)}
          style={{
            width: "100%",
            marginTop: 10,
          }}
      ...
      <div>
        ...
        >
          <div>
            <CreditSales />
            <Button
              onClick={() => setOpenCreditSales(false)}
              style={{
                marginTop: 10,
              }}
              variant="contained"
