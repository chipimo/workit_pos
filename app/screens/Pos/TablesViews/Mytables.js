...
var Mytables = function (props) {
    ...
    var _c = React.useState(false), DeletOpen = _c[0], setDeletOpen = _c[1];
    var _d = React.useState(null), rowIdData = _d[0], setRowIdData = _d[1];
    var _e = React.useState(null), selected = _e[0], setSeleted = _e[1];
    var _f = React.useState(0), total = _f[0], setTotal = _f[1];
    var _g = React.useState("1"), qty = _g[0], setQty = _g[1];
    var _h = React.useState([]), selectedRows = _h[0], setSeletedRows = _h[1];
    var _j = React.useState([]), selectedRowsDefault = _j[0], setSeletedRowsDefault = _j[1];
    var _k = React.useState(""), tableName = _k[0], settableName = _k[1];
    var _l = React.useState(""), time = _l[0], settime = _l[1];
    var _m = React.useState(""), date = _m[0], setdate = _m[1];
    var _o = React.useState(""), tableKey = _o[0], settableKey = _o[1];
    var history = react_router_dom_1.useHistory();
    var _p = React.useState({
        data: [],
    }), purchase = _p[0], setPurchase = _p[1];
    var _q = React.useState(0), page = _q[0], setPage = _q[1];
    var _r = React.useState(10), rowsPerPage = _r[0], setRowsPerPage = _r[1];
    var _s = React.useState(false), isKitchen = _s[0], setIsKitchen = _s[1];
    ...
    var handleOpenDelet = function (rowId) {
        setRowIdData(rowId);
        setDeletOpen(true);
    };
    var handleCloseDelet = function () {
        setDeletOpen(false);
    };
    var handleDelet = function () {
        dataBase_1.default.HandleTables({ _type: "DeleteTableFromMyTables", id: rowIdData.id }, function (callback) {
            dataBase_1.default.HandleTables({ _type: "getMyTabes" }, function (reciveCallback) {
                ...
                var tempData = reciveCallback.data.sort(compare);
                setState(__assign({}, state, { data: tempData }));
                react_toastify_1.toast("Table Deleted Successfully", {
                    position: "top-right",
                    autoClose: 5000,
                    type: "success",
        ...
        dataBase_1.default.HandleTables({ _type: "getMyTabes" }, function (reciveCallback) {
            ...
            reciveCallback.data.map(function (data) {
                if (data.user === props.User.userLogged.userName ||
                    props.User.userLogged.prevarges === "1" || props.User.userLogged.prevarges === "2") {
                    dataArr.push(data);
                }
            });
            ...
            if (props.User.userLogged.prevarges === "1" || props.User.userLogged.prevarges === "2")
    ...
    var handlesubmit = function () {
        ...
        selected.casher = props.User.userLogged.userName;
        ...
        if (index !== -1) {
            ...
            selectedRows[index].amountInstore =
                selectedRows[index].amountInstore - parseInt(qty);
            // setTimeout(() => {
            var data = {
                qty: parseInt(qty),
                table: tableName,
    ...
    return (React.createElement("div", { style: { padding: 20, width: "100%", height: "95vh", overflow: "auto" } },
        ...
        React.createElement(material_table_1.default, { icons: tableIcons, title: "My Tables", columns: state.columns, data: state.data, 
            ...
            //   exportButton: true,
            // }}
            actions: props.User.userLogged.prevarges === "1" || props.User.userLogged.prevarges === "2"
                ? [
                    {
                        icon: "edit",
                        disabled: props.User.userLogged.prevarges === "1" || props.User.userLogged.prevarges === "2" ? false : true,
                        tooltip: "Edit Table",
                    ...
                    {
                        icon: "delete",
                        disabled: props.User.userLogged.prevarges === "1" ||
                            props.User.userLogged.prevarges === "2"
                            ? false
                            : true,
                        tooltip: "Delete Bill",
                        onClick: function (event, rowData) {
                            handleOpenDelet(rowData);
                        },
                    },
                ]
                : [
        ...
        React.createElement("div", null,
            React.createElement(Modal_1.default, { "aria-labelledby": "transition-modal-title", "aria-describedby": "transition-modal-description", className: classes.modal, open: DeletOpen, onClose: handleCloseDelet, closeAfterTransition: true, BackdropComponent: Backdrop_1.default, BackdropProps: {
                    timeout: 500,
                } },
                React.createElement(Fade_1.default, { in: DeletOpen },
                    React.createElement("div", { className: classes.alertPaper },
                        React.createElement(lab_1.Alert, { severity: "warning" },
                            ...
                            React.createElement("strong", null, "Delet this table?")),
                        React.createElement("div", null,
                            React.createElement(core_1.Button, { onClick: handleDelet, variant: "outlined", color: "secondary" }, "Yes! i want"),
                            React.createElement(core_1.Button, { onClick: handleCloseDelet, color: "primary", variant: "outlined" }, "No! i don't")))))),
        React.createElement("div", null,
                    ...
                    React.createElement("div", { className: classes.paper },
                        ...
                        React.createElement("div", { style: { display: "flex", width: "100%" } },
                            ...
                            React.createElement("div", { style: { marginLeft: 10, marginRight: 10 } },
                                React.createElement(core_1.Button, { onClick: function () {
                                        if (qty !== "" && selected.amountInstore) {
                                            handlesubmit();
                                        }
                                        else {
                                            react_toastify_1.toast("Fill in the required fields", {
                                                position: "top-right",
                                                autoClose: 5000,
                                                type: "error",
                                                hideProgressBar: false,
                                    ...
                                    }, variant: "outlined", startIcon: React.createElement(AddShoppingCart_1.default, null) }, "Add to bill"))),
                        React.createElement("div", { style: { padding: 10 } },
                            React.createElement(core_1.Divider, null)),
                        React.createElement("div", { style: { marginTop: 10, marginBottom: 10 } },
                            React.createElement(Paper_1.default, { className: classes.root },
                                ...
                                React.createElement(TablePagination_1.default, { rowsPerPageOptions: [
                                        10, 25, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000,
                                    ], component: "div", count: selectedRows.length, rowsPerPage: rowsPerPage, page: page, onChangePage: handleChangePage, onChangeRowsPerPage: handleChangeRowsPerPage }))),
                        React.createElement("div", { style: { padding: 10 } },
                            React.createElement(core_1.Divider, null)),
                        React.createElement("div", { style: { marginTop: 10, marginBottom: 10 } },
                            React.createElement(core_1.Button, { onClick: function () {
