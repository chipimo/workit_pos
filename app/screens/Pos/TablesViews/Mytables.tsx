...
const Mytables = (props) => {
  ...
  const [rowIdData, setRowIdData] = React.useState(null);

  const [selected, setSeleted] = React.useState(null);
  ...
  const handleDelet = () => {
    appDb.HandleTables(
      { _type: "DeleteTableFromMyTables", id: rowIdData.id },
      (callback) => {
        appDb.HandleTables({ _type: "getMyTabes" }, (reciveCallback) => {
          ...
          let tempData = reciveCallback.data.sort(compare);
  ...
  const handlesubmit = () => {
    ...
    if (index !== -1) {
      ...
      appDb.HandleTables(data, (callback) => {
        ...
        toast(`Added ${qty} successfully to`, {
          position: "top-right",
          autoClose: 5000,
          type: "success",
          hideProgressBar: false,
            ...
            ? [
                {
                  icon: "edit",
                  disabled:
                    props.User.userLogged.prevarges === "1" || props.User.userLogged.prevarges ==="2" ? false : true,
                  tooltip: "Edit Table",
          ...
          <Fade in={DeletOpen}>
            <div className={classes.alertPaper}>
              <Alert severity="warning">
                ...
                You are sure you want to <strong>Delet this table?</strong>
              </Alert>
              <div>
                <Button
                  onClick={handleDelet}
