...
var react_numpad_1 = require("react-numpad");
...
var index = function (props) {
    ...
    var _x = React.useState(false), openCreditMdodel = _x[0], setOpenCreditMdodel = _x[1];
    var _y = React.useState({ data: [] }), List = _y[0], setList = _y[1];
    var _z = React.useState({
        ...
        bottom2: false,
        right: false,
    }), Drawerstate = _z[0], setDrawerState = _z[1];
    var _0 = React.useState({
        ...
        amounOwing: 0,
        amountCreditPaid: 0,
    }), values = _0[0], setValues = _0[1];
    var _1 = React.useState({
        sliptCard: "",
        sliptCash: "",
    }), sliptPayment = _1[0], setSliptPayment = _1[1];
    var _2 = React.useState(""), dateToPay = _2[0], setDateToPay = _2[1];
    var _3 = React.useState({}), whatToSave = _3[0], setWhatToSave = _3[1];
    ...
    var _4 = React.useState(false), open = _4[0], setOpen = _4[1];
    var _5 = React.useState(true), loadCustomerOnce = _5[0], setloadCustomerOnce = _5[1];
    var _6 = React.useState(""), AlertMsg = _6[0], setAlertMsg = _6[1];
    var _7 = React.useState(0), ChangeDue = _7[0], setChangeDue = _7[1];
    var _8 = React.useState(0), BalanceDue = _8[0], setBalanceDue = _8[1];
    var _9 = React.useState(0), RtxChangeDue = _9[0], setRtxChangeDue = _9[1];
    var _10 = React.useState(0), RtxBalanceDue = _10[0], setRtxBalanceDue = _10[1];
    var _11 = React.useState([]), payment_mode = _11[0], setPayment_mode = _11[1];
    var _12 = React.useState(true), LoadOnceOff = _12[0], setLoadOnceOff = _12[1];
    var _13 = React.useState(false), editList = _13[0], setEditList = _13[1];
    var _14 = React.useState({
        cashError: false,
        cardError: false,
        paymentError: false,
        paymentErrorMsg: "",
    }), sliptErrors = _14[0], setSliptErrors = _14[1];
    var _15 = React.useState([]), MainCategory = _15[0], setMainCategory = _15[1];
    var _16 = React.useState(""), paymentModeSelected = _16[0], setPaymentModeSelected = _16[1];
    var _17 = React.useState(false), requestPass = _17[0], setRequestPass = _17[1];
    var _18 = React.useState(""), extraMsg = _18[0], setExtraMsg = _18[1];
    var _19 = React.useState(false), openPassDailogRequest = _19[0], setOpenPassDailogRequest = _19[1];
    var _20 = React.useState({ value: moment() }), selectedDate = _20[0], setSelectedDate = _20[1];
    var _21 = React.useState(null), selectedExtraIndex = _21[0], setSelectedExtraIndex = _21[1];
    var _22 = React.useState(null), selectedExtraItem = _22[0], setSelectedExtraItem = _22[1];
    ...
    var _23 = React.useState({
        ...
        productKey: "",
        amountInstore: 0,
    }), nodeCall = _23[0], setNodeCall = _23[1];
    ...
    var OnAmounOwing = function (prop) { return function (event) {
        var totalAmount = values.amount - parseFloat(event.target.value);
        setValues(__assign({}, values, { amountCreditPaid: event.target.value, amounOwing: totalAmount }));
    }; };
    var handlePaidChange = function (prop) { return function (event) {
        ...
        if (prop === "discount") {
            if (event.target.value !== "") {
                var amount = GrandTotal - parseFloat(values.amount);
                // var rtxAmount = props.Cart.workP_total - parseFloat(event.target.value);
                setValues(__assign({}, values, { totaltoPay: amount, 
            ...
            if (prop === "amount")
                setValues(__assign({}, values, { amount: event.target.value }));
            var Change = parseFloat(event.target.value) - GrandTotal;
            var Balance = GrandTotal - parseFloat(event.target.value);
            var rtxChange = parseFloat(event.target.value) - GrandTotal;
            var rtxBalance = GrandTotal - parseFloat(event.target.value);
            if (Change > 0) {
                setChangeDue(Change);
    ...
    var CalculateTotal = function () {
        ...
        ipcRenderer.send("printToDisplay", {
            type: "print",
            message: tempTotal,
        });
    };
    ...
    var handleQchange = function (event, type) {
        if (type === "add") {
            if (StockInstore <= 0) {
                react_toastify_1.toast("Out of stock", {
                    position: "top-right",
                    autoClose: 5000,
                    type: "error",
                    hideProgressBar: false,
            ...
            else if (StockInstore < parseInt(event.target.value)) {
                react_toastify_1.toast("Products Out of stock", {
                    position: "top-right",
                    autoClose: 5000,
                    type: "error",
                    hideProgressBar: false,
    ...
    var makeSliptPayment = function () {
        var compValue = parseFloat(sliptPayment.sliptCard) + parseFloat(sliptPayment.sliptCash);
    ...
    var PaymentProcessor = function (type, en) {
        ...
        props.Cart.items.map(function (items) {
            toPrint.push({
                ...
                Qty: items.qnt,
                Price: parseFloat(items.sallingprice),
                    ...
                    generateInvoiceNumber({ type: "get", table: "invNum" }, function (callback) {
                        ...
                        dataBase_1.default.HandelReports({
                            ...
                            data: {
                                ...
                                Card_slipt: sliptPayment.sliptCard === ""
                                    ? 0
                                    : sliptPayment.sliptCard,
                                Cash_slipt: sliptPayment.sliptCash === ""
                                    ? 0
                                    : sliptPayment.sliptCash,
                                // Date: moment().format("ddd MMM Do, YYYY"),
                                Date: moment().format("DD-MMM-YYYY"),
                                Datetrack: moment().format("MM/DD/YYYY"),
                                DateTrackNumber: parseFloat(DateNumInput),
                                ...
                                amounOwing: values.amounOwing,
                                amountCreditPaid: values.amountCreditPaid,
                                dateToPay: dateToPay,
                            },
                        }, function (callback) { });
                        props.dispatchEvent({
    ...
    var onChange = function (value, inputValue) {
        setDateToPay(value.format("DD-MM-YYYY"));
            ...
            React.createElement("div", { className: classes.root, style: {
                ...
                return (React.createElement("div", { key: items.productKey },
                    React.createElement(ListItem_1.default, { style: { padding: 0 }, button: true, selected: selectedIndex === items.productKey, onClick: function (event) {
                        ...
                        React.createElement("input", { onInput: function (e) { return handleQchange(e, "input"); }, 
                            // value={items.qnt}
                            placeholder: "qty", style: { width: 40 } }),
                        React.createElement(ListItemIcon_1.default, null,
                        ...
                        React.createElement(ListItemText_1.default, { primary: React.createElement(Typography_1.default, { style: { width: 200 } }, items.ItemName), secondary: React.createElement("div", null,
                                React.createElement("div", null, props.TicketToPrint.active
                                    ? items.qnt === 1
                                        ? "got " + items.qnt + " item"
                                        : "got " + items.qnt + " items"
                                    : "we have added " + items.qnt + " out of " + items.totalQty),
                            ...
                            React.createElement(core_1.Paper, { style: {
                                ...
                                return (React.createElement("div", { key: items.productKey },
                                    React.createElement(ListItem_1.default, { button: true, selected: selectedIndex === items.productKey, onClick: function (event) {
                                            handleListItemClick(event, items.productKey);
                                            setStockInstore(parseFloat(items.amountInstore));
                                            setQu(items.qnt);
                                            setNodeCall({
                                                items: props.Cart.items,
                                                productKey: items.productKey,
                                        ...
                                        React.createElement(ListItemText_1.default, { primary: React.createElement(Typography_1.default, { variant: "h6" }, items.ItemName) }))));
                            })),
                            React.createElement("div", { style: {
                                    width: "60%",
                                    padding: 10,
                                ...
                                React.createElement("div", { style: {
                                    ...
                                    React.createElement("div", null,
                                        React.createElement(react_numpad_1.default.Number, { onChange: function (value) {
                                                setValues(__assign({}, values, { amount: value }));
                                                var Change = parseFloat(value) - GrandTotal;
                                                var Balance = GrandTotal - parseFloat(value);
                                                var rtxChange = parseFloat(value) - GrandTotal;
                                                var rtxBalance = GrandTotal - parseFloat(value);
                                                if (Change > 0) {
                                                    setChangeDue(Change);
                                                    setRtxChangeDue(rtxChange);
                                                }
                                            ...
                                            }, placeholder: "Amount", value: values.amount, decimal: 2 },
                                            React.createElement(FormControl_1.default, { fullWidth: true, className: classes.margin, variant: "outlined" },
                                                ...
                                                React.createElement(core_1.OutlinedInput, { disabled: values.discount === 0 ? false : true, style: { height: 70, fontSize: 25 }, id: "o utlined-adornment-amount", value: values.amount, error: amountPaidErr, startAdornment: React.createElement(core_1.InputAdornment, { position: "start" }, "K"), labelWidth: 60 }))))),
                                React.createElement("div", { style: {
                                        width: "100%",
                                        display: "flex",
                                        justifyContent: "space-between",
                                ...
                                React.createElement("div", { style: { marginTop: 50 } },
                                    React.createElement(Button_1.default, { onClick: function (event) {
                                            ...
                                            // handleClick2(event);
                                        }, style: { height: 70, marginRight: 10 }, variant: "contained", color: "secondary" },
                                        React.createElement(Typography_1.default, { variant: "h6" }, "Cash payment")),
                                    React.createElement(Button_1.default, { disabled: props.TicketToPrint.active, onClick: function (event) {
                                            setOpenCreditMdodel(true);
                                        }, style: {
                                            backgroundColor: props.TicketToPrint.active
                                                ? "#CCCED7"
                                                : "#6E3401",
                                        ...
                                        React.createElement(Typography_1.default, { style: { color: "#fff" }, variant: "h6" }, "Credit sale")),
                                    React.createElement(Button_1.default, { disabled: props.TicketToPrint.active, onClick: function (event) {
                                            if ((values.amount === 0 && values.discount === 0) ||
                                                null) {
                                                setamountPaidErr(true);
                                        ...
                                        React.createElement(Typography_1.default, { style: { color: "#fff" }, variant: "h6" }, "Credit Card")),
                                    React.createElement(Button_1.default, { disabled: props.TicketToPrint.active, onClick: function (event) {
                                            setSliptOpen(true);
                                        }, style: {
                                            backgroundColor: props.TicketToPrint.active
                                        ...
                                        React.createElement(Typography_1.default, { style: { color: "#fff" }, variant: "h6" }, "Split Payment")),
                                    React.createElement(Button_1.default, { disabled: props.TicketToPrint.active, variant: "contained", color: "secondary", onClick: function (event) {
                                        ...
                                        React.createElement(Typography_1.default, { style: { color: "#fff" }, variant: "h6" }, "Other Payment")),
                                    ...
                                    React.createElement(Modal_1.default, { "aria-labelledby": "transition-modal-title", "aria-describedby": "transition-modal-description", className: classes.modal, open: openCreditMdodel, onClose: setOpenCreditMdodel, closeAfterTransition: true, BackdropComponent: Backdrop_1.default, BackdropProps: {
                                            timeout: 500,
                                        } },
                                        React.createElement(Fade_1.default, { in: openCreditMdodel },
                                            React.createElement("div", { className: classes.paper },
                                                React.createElement("div", { style: { width: 450, height: 550 } },
                                                    React.createElement("div", { style: { marginTop: 15 } }),
                                                    React.createElement(Typography_1.default, { variant: "h6" }, "Credit Sale"),
                                                    React.createElement(Typography_1.default, { variant: "h6" },
                                                        "Total Amount:",
                                                        " ",
                                                        values.amounOwing === 0
                                                    ...
                                                    React.createElement(core_1.Divider, null),
                                                    React.createElement("div", { style: { marginTop: 15 } }),
                                                    React.createElement(TextField_1.default, { id: "outlined-basic", label: "Amount Payed", variant: "outlined", name: "creditAmountPaid", fullWidth: true, type: "number", value: values.amountCreditPaid, onChange: OnAmounOwing("amounOwing") }),
                                                    React.createElement("div", { style: { marginTop: 15 } }),
                                                    React.createElement(Typography_1.default, { variant: "h6" }, "Date of payment"),
                                                    React.createElement(ciqu_react_calendar_1.default, { onChange: onChange, value: selectedDate.value, allowClear: true, disabled: false, placeholder: "Date of payment", format: "DD-MM-YYYY" }),
                                                    React.createElement("div", { style: { marginTop: 25 } }),
                                                    React.createElement(core_1.Divider, null),
                                                    React.createElement("div", { style: { marginTop: 15 } }),
                                                    React.createElement(Button_1.default, { style: { marginTop: 15 }, color: "primary", variant: "contained", onClick: function () {
                                                            PaymentProcessor("", "creditSale");
                                                            setOpenCreditMdodel(false);
                                                            toggleDrawer("bottom", false);
                                                        } }, "Save"),
                                                    React.createElement(Button_1.default, { style: { marginLeft: 7, marginTop: 15 }, variant: "contained", onClick: function () { return setOpenCreditMdodel(false); } }, "Cancel"))))),
                                            ...
                                            React.createElement("div", { className: classes.paper2 },
                                                React.createElement("div", null,
                                                    React.createElement("form", null,
                                                        React.createElement(TextField_1.default, { id: "outlined-basic", label: "Card Payment", variant: "outlined", name: "sliptCard", fullWidth: true, type: "number", value: sliptPayment.sliptCard, onChange: SplitPayment }),
                                                        React.createElement("div", { style: { marginTop: 5 } }),
                                                        React.createElement(core_1.Divider, null),
                                                        React.createElement("div", { style: { marginTop: 5 } }),
