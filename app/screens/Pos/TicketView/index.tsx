...
const index = (props) => {
  ...
  const [openCreditMdodel, setOpenCreditMdodel] = React.useState(false);
  ...
  const [dateToPay, setDateToPay] = React.useState("");
  ...
  const [openPassDailogRequest, setOpenPassDailogRequest] =
  ...
  const OnAmounOwing = (prop) => (event) => {
    var totalAmount = values.amount - parseFloat(event.target.value);
    setValues({
      ...values,
      amountCreditPaid: event.target.value,
      amounOwing: totalAmount,
    });
  };
      ...
      appDb.HandelProducts(
        ...
        (receiveCallback) => {
          ...
          receiveCallback[0].map((list) => {
            if (list.amountInstore != 0) data.push(list);
          });
          setTimeout(() => {
  ...
  const handleQchange = (event, type) => {
    if (type === "add") {
      if (StockInstore <= 0) {
        toast(`Out of stock`, {
          position: "top-right",
  ...
  const makeSliptPayment = () => {
    const compValue =
      parseFloat(sliptPayment.sliptCard) + parseFloat(sliptPayment.sliptCash);
            ...
            return (
              <div key={items.productKey}>
                ...
                >
                  ...
                  <input
                    onInput={(e) => handleQchange(e, "input")}
                    // value={items.qnt}
                    placeholder="qty"
                    style={{ width: 40 }}
                  ></input>
                          ...
                          >
                            ...
                            {/* <ListItemSecondaryAction>
                              <Typography variant="h6">
                                <Currency
                                  locale="en"
                                  quantity={parseFloat(items.sallingprice)}
                                  symbol={
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          ...
                          <OutlinedInput
                            disabled={values.discount === null ? false : true}
                            style={{ height: 70, fontSize: 25 }}
                            id="o utlined-adornment-amount"
                            value={values.amount}
                    ...
                    <div style={{ marginTop: 50 }}>
                      <Button
                        onClick={(event) => {
                          if (
                            (values.amount === 0 && values.discount === 0) ||
                            0
                          ) {
                      ...
                      <Modal
                        ...
                        aria-describedby="transition-modal-description"
                        className={classes.modal}
                        open={openCreditMdodel}
                        onClose={setOpenCreditMdodel}
                        closeAfterTransition
                        BackdropComponent={Backdrop}
                        BackdropProps={{
                          timeout: 500,
                      ...
                      >
                        <Fade in={openCreditMdodel}>
                          <div className={classes.paper}>
                            <div style={{ width: 450, height: 550 }}>
                              <div style={{ marginTop: 15 }} />
                              <Typography variant="h6">Credit Sale</Typography>
                              <Typography variant="h6">
                                Total Amount:{" "}
                                {values.amounOwing === 0
                                  ? values.amount
                              ...
                              <TextField
                                ...
                                fullWidth
                                type="number"
                                value={values.amountCreditPaid}
                                onChange={OnAmounOwing("amounOwing")}
                              />
                              <div style={{ marginTop: 15 }} />
                              <Typography variant="h6">
                                Date of payment
                              ...
                              <Button
                                ...
                                variant="contained"
                                onClick={() => setOpenCreditMdodel(false)}
                              >
                                Cancel
                              </Button>
                            </div>
