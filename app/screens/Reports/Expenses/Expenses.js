...
var EnhancedTableToolbar = function (props) {
    ...
    return (React.createElement(Toolbar_1.default, { className: classes.root },
        numSelected > 0 ? (React.createElement(core_1.Typography, { className: classes.title, color: "inherit", variant: "subtitle1", component: "div" },
            numSelected,
            " selected")) : (React.createElement(core_1.Typography, { className: classes.title, variant: "h6", id: "tableTitle", component: "div" }, "Expenses")),
...
var Expenses = function (props) {
    ...
    var _k = React.useState(0), Totals = _k[0], setTotals = _k[1];
    var _l = React.useState(false), open = _l[0], setOpen = _l[1];
    var _m = React.useState(false), openError = _m[0], setOpenError = _m[1];
    ...
    var handleGetSaleData = function (prop) {
        dataBase_1.default.HandelReports({
            ...
            callback.data.map(function (list) {
                Total_expense = parseFloat(list.cost) + Total_expense;
            });
            setTotals(Total_expense);
        });
    };
