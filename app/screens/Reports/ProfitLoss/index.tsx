    ...
    appDb.HandelReports(
      ...
      (callback) => {
        ...
        callback.data.map((list) => {
          // console.log(list)
          tempTotal =
            parseFloat(list.GrandTotal) - parseFloat(list.Balance) + tempTotal;

          list.TicketList.list.map((ticket) => {
            tempBuyPrices =
            parseFloat(ticket.buyingPrice) * parseInt(ticket.qnt) + tempBuyPrices;
          });
        });
    ...
    appDb.HandelReports(
      ...
      (callback) => {   
        callback.data.map((expenses) => {
          tempExpenses = parseFloat(expenses.cost) + tempExpenses;
        });
