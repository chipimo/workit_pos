...
var CreditSales_1 = require("./CreditSales");
...
var index = function (props) {
    ...
    return (React.createElement("div", { className: classes.root },
        React.createElement(Tabs_1.default, { orientation: "vertical", variant: "scrollable", value: value, onChange: handleChange, "aria-label": "Vertical tabs ", className: classes.tabs },
            ...
            React.createElement(Tab_1.default, __assign({ label: "Credit Sales" }, a11yProps(13), { style: {
                    backgroundColor: selected === 13 ? "#0A56D9" : "transparent",
                    color: selected === 13
                        ? "#fff"
                        : props.Theme.theme === "light"
                            ? "#3b3b3b"
        ...
        React.createElement(TabPanel, { value: value, index: 13 },
