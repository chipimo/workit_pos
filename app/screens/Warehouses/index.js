        ...
        React.createElement(core_1.Paper, { className: classes.root },
            ...
            React.createElement(core_1.Paper, { style: { display: "flex", justifyContent: "flex-end" } },
                React.createElement(core_1.Typography, { variant: "h6", style: { marginRight: 100 } },
                    "Total Stock ",
                    state.total)),
            React.createElement(TablePagination_1.default, { rowsPerPageOptions: [10, 25, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000], component: "div", count: state.rows.length, rowsPerPage: rowsPerPage, page: page, onChangePage: handleChangePage, onChangeRowsPerPage: handleChangeRowsPerPage }),
