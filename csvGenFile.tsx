...
export async function saveToCsvFile(list) {
  ...
  const file = `${userhome}/Documents/Workit-Tec/Reports/${list.type}/doc.md`;

  fs.ensureFileSync(file);
  const pdfPathMain = `${userhome}/Documents/Workit-Tec/Reports/${list.type}/${list.type}-Report-${CreateId()}.csv`;
