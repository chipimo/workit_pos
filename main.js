...
ipcMain.on("printToDisplay", function (event, arg) {
    serialport_1.default(arg);
});
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    file = userhome + "/Documents/Workit-Tec/reports/doc.md";
                    fs.ensureFileSync(file);
                    pdfPathMain = userhome + "/Documents/Workit-Tec/reports/financial-Report-" + CreateId() + ".pdf";
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 6]);
